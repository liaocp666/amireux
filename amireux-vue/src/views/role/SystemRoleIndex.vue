        ...
        <a-form-model
          ...
          <a-col span="8">
            <a-form-model-item label="名称" prop="title">
              <a-input v-model="queryParam.title" placeholder="角色名称"/>
            </a-form-model-item>
          </a-col>
          <a-col span="8">
            ...
            <template slot="action" slot-scope="record">
              ...
              <a-dropdown>
                ...
                <template #overlay>
                  <a-menu>
                    <a-menu-item>
                      <a @click="$refs.SystemRoleAuth.preData(record.id)">授权权限</a>
                    </a-menu-item>
                  </a-menu>
                </template>
              </a-dropdown>
...
import SystemRoleAuth from '@/views/role/SystemRoleAuth'
import SystemRoleAdd from '@/views/role/SystemRoleAdd'
import SystemRoleEdit from '@/views/role/SystemRoleEdit'
